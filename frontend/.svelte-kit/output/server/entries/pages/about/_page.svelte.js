...
const css = {
  code: ".main.svelte-1ovl3os{max-width:64rem;margin:0 auto}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-4mnfwt_START -->${$$result.title = `<title>About me</title>`, ""}<meta name="description" content="About me"><!-- HEAD_svelte-4mnfwt_END -->`, ""} <div class="headline" data-svelte-h="svelte-1dsumvb"><h1>About me</h1></div> <div class="main svelte-1ovl3os" data-svelte-h="svelte-1q1927a"><p>Hey i am Tim Köster a software developer from Germany. I started working in
